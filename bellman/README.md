This crate, `zakura-bellman`, is the Zakura fork of upstream
[`bellman`](https://crates.io/crates/bellman), maintained in
[`zakura-core/libraries`](https://github.com/zakura-core/libraries). The library
target remains `bellman`, so source imports are unchanged. Use it as a drop-in
replacement by renaming the dependency:

```toml
[dependencies]
bellman = { package = "zakura-bellman", version = "1.0.0-rc.1" }
```
