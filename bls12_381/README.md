This crate, `zakura-bls12-381`, is the Zakura fork of upstream
[`bls12_381`](https://crates.io/crates/bls12_381), maintained in
[`zakura-core/libraries`](https://github.com/zakura-core/libraries). The library
target remains `bls12_381`, so source imports are unchanged. Use it as a drop-in
replacement by renaming the dependency:

```toml
[dependencies]
bls12_381 = { package = "zakura-bls12-381", version = "1.0.0-rc.4" }
```
