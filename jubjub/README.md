This crate, `zakura-jubjub`, is the Zakura fork of upstream
[`jubjub`](https://crates.io/crates/jubjub), maintained in
[`zakura-core/libraries`](https://github.com/zakura-core/libraries). The library
target remains `jubjub`, so source imports are unchanged. Use it as a drop-in
replacement by renaming the dependency:

```toml
[dependencies]
jubjub = { package = "zakura-jubjub", version = "1.0.0-rc.4" }
```

# jubjub

<img
 alt="Jubjub curve diagram"
 width="15%"
 align="right"
